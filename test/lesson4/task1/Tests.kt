...
class Tests {
    ...
    fun russian() {
        ...
        assertEquals("двенадцать тысяч девятьсот", russian(12900))
        assertEquals("один миллиард двести тридцать четыре миллиона пятьсот шестьдесят семь тысяч восемьсот девяносто", russian(1234567890))
    }
}
